...
\input{database/introduction/introduction}
\input{database/trajectorySimilarity/trajectorySimilarity}
\input{databse/surveys/surveys}
\input{database/socialNavigation/socialNavigation}
\input{database/datasetsAndBenchmarks/datasetsAndBenchmarks}
