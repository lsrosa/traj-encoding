\subsection{Trajectory Learning}\label{sec: traj learning}

\rev{check this out \url{https://tslearn.readthedocs.io/en/latest/user_guide/shapelets.html}}

\method{2014 - Sequence to Sequence Learning with Neural Networks}

\textbf{Name: seq2seq}

\cite{sutskever2014sequence}

\method{2017 - Identifying Human Mobility via Trajectory Embeddings}
...
\method{2018 - Self-Consistent Trajectory Autoencoder: Hierarchical Reinforcement Learning with Trajectory Embeddings}
...
\method{2018 - Anomalous Trajectory Detection Using Recurrent Neural Network}
...
\method{2018 - Deep Representation Learning for Trajectory Similarity Computation}
...
\method{2020 - Trembr: Exploring Road Networks for Trajectory Representation Learning}
...
\method{2019 - Computing Trajectory Similarity in Linear Time: A Generic Seed-Guided Neural Metric Learning Approach}
...
\method{2020 - Trajectory similarity learning with auxiliary supervision and optimal matching}
...
\method{2020 - MARC: a robust method for multiple-aspect trajectory classification via space, time, and semantic embeddings}
...
\method{2021 - Embedding-Based Similarity Computation for Massive Vehicle Trajectory Data}
...
\method{2021 - STENet: A hybrid spatio-temporal embedding network for human trajectory forecasting}
...
\method{2021 - A Graph-Based Approach for Trajectory Similarity Computation in Spatial Networks}
...
\method{2021 - T3S: Effective Representation Learning for Trajectory Similarity Computation}
...
\method{2021 - How meaningful are similarities in deep trajectory representations?}
...
\method{2022 - Spatio-Temporal Trajectory Similarity Learning in Road Networks}
...
\method{2022 - Deep Fuzzy Contrast-Set Deviation Point Representation and Trajectory Detection}

\cite{ahmed2022deep} Grid-map based, contrastive learning. 

\textbf{notes:} hard to understand what they are doing here.

\method{2022 - Contrastive Pre-training of Spatial-Temporal Trajectory Embeddings}
...
\method{2022 - TMN: Trajectory Matching Networks for Predicting Similarity}
...
\method{2022 - TSNE: Trajectory Similarity Network Embedding}
...
\method{2022 - Towards robust trajectory similarity computation: Representation-based spatio-temporal similarity quantification}
...
\method{2023 - Spatial-temporal fusion graph framework for trajectory similarity computation}
...
\method{2023 - GRLSTM: Trajectory Similarity Computation with Graph-Based Residual LSTM}
...
\method{2023 - Contrastive Trajectory Similarity Learning with Dual-Feature Attention}
...
\method{2023 - Spatio-Temporal Trajectory Similarity Measures: A Comprehensive Survey and Quantitative Study}
